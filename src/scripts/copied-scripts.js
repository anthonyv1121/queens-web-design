...
//             var e, f, g, h, i, j = b(this), k = "granim-" + c, l = j.attr("data-gradient-bg"), m = [], n = [], o = {};
//             if (j.prepend('<canvas id="' + k + '"></canvas>'),
//             f = /^(#[0-9|a-f|A-F]{6}){1}([ ]*,[ ]*#[0-9|a-f|A-F]{6})*$/.test(l),
//             f === !0) {
//                 for (l = l.replace(" ", ""),
//                 l = l.split(","),
//                 e = l.length,
...
//             a.scroll.busy === !1 && (a.scroll.busy = !0,
//             e(function(b) {
//                 a.scroll.update(b)
//             })),
...
//         if (a.scroll.y = d ? mr_parallax.mr_getScrollPosition() : c.pageYOffset,
//         a.scroll.busy = !1,
...
//         var e;
//         "" !== c && "#" !== c && null === c.match(/#\/.*/) && (e = b(".accordion > li > .accordion__title#" + c.replace("#", "")),
//         e.length && (b("html, body").stop(!0).animate({
...
// //             }
// //             a(this).css("background-position", "initial").css("opacity", "1")
// //         })
// //     }
// //     ,
...
//             var c, d = b(this), e = d.attr("data-date"), f = "undefined" != typeof d.attr("data-days-text") ? "%D " + d.attr("data-days-text") + " %H:%M:%S" : "%D days %H:%M:%S", f = "undefined" != typeof a.countdown.options.format ? a.countdown.options.format : f, g = "undefined" != typeof d.attr("data-date-format") ? d.attr("data-date-format") : f;
...
//         e === !1 ? (a.dropdowns.repositionDropdowns(b),
...
//             e = null,
//             a.css("left", -b + c),
//             a.find('.dropdown__content:not([class*="lg-12"])').length && (e = a.find(".dropdown__content"),
//             e.css("left", d - c))
//         }),
...
//             f = null,
//             a.css("right", -c + d),
//             a.find('.dropdown__content:not([class*="lg-12"])').length && (f = a.find(".dropdown__content"),
//             f.css("right", e - d))
//         }),
//         a(".dropdown__content").each(function() {
//             var a, d, e, f, g, h;
...
//               , d = c.siblings("label")
//               , e = "input-assigned-" + a;
//             "undefined" == typeof c.attr("id") || "" === c.attr("id") ? (c.attr("id", e),
//             d.attr("for", e)) : (e = c.attr("id"),
//             d.attr("for", e))
//         }),
...
//             var b, c, d, e, f, g, h, i = jQuery(this), j = i.find("div.recaptcha");
...
//             j.length || (b = i.find("button[type=submit]").closest('[class*="col-"]'),
...
//             a.forms.captcha.done === !1 ? jQuery('script[src*="recaptcha/api.js"]').length || (e = jQuery("<script async defer>"),
//             f = "https://www.google.com/recaptcha/api.js?onload=mrFormsCaptchaInit&render=explicit",
//             e.attr("src", f),
//             jQuery("body").append(e),
//             a.forms.captcha.done = !0) : "undefined" != typeof grecaptcha && a.forms.captcha.renderWidgets()
//         })
//     }
//     ,
//     a.forms.submit = function(d) {
//         d.preventDefault ? d.preventDefault() : d.returnValue = !1;
//         var e, f, g, h, i, j = b("body"), k = b(d.target).closest("form"), l = "undefined" != typeof k.attr("action") ? k.attr("action") : "", m = k.find('button[type="submit"], input[type="submit"]'), n = 0, o = k.attr("original-error"), p = k.find("div.recaptcha").length ? !0 : !1;
...
//                     a.forms.resetForm(k),
//                     a.forms.showFormSuccess(g, f, 1e3, 5e3, 500),
//                     a.forms.captcha.resetWidgets()) : (f.attr("original-error", f.text()),
...
//             var a = b(this);
//             b('[name="' + b(this).attr("name") + '"]:checked').length || (f = 1,
...
//             f = 1) : b(this).removeClass("field-error")
//         }),
...
//             f = 1)
//         }),
//         a.find("div.recaptcha").length && "undefined" != typeof a.attr("data-recaptcha-sitekey") && (d = b(a.find("div.recaptcha")),
//         "" !== grecaptcha.getResponse(a.data("recaptchaWidgetID")) ? d.removeClass("field-error") : (d.addClass("field-error"),
//         f = 1)),
...
//             var f, g, h = "4079540202.b9b1d8a.1d13c245c68d4a17bfbff87919aaeb14", i = "b9b1d8ae049d4153b24a6332f0088686";
//             b(".instafeed[data-access-token][data-client-id]").length && (f = b(".instafeed[data-access-token][data-client-id]").first().attr("data-access-token"),
//             g = b(".instafeed[data-access-token][data-client-id]").first().attr("data-client-id"),
//             "" !== f && (h = f),
//             "" !== g && (i = g)),
...
//         "undefined" != typeof c.google && "undefined" != typeof c.google.maps && (a.maps.instances = [],
//         jQuery(".gmaps-active").each(function() {
//             var b, c, e, f, g, h, i, j = this, k = jQuery(this), l = jQuery(d).width() > 766 ? !0 : !1, m = ("undefined" != typeof k.attr("data-zoom-controls") ? !0 : !1,
//             "undefined" != typeof k.attr("data-zoom-controls") ? k.attr("data-zoom-controls") : !1), n = "undefined" != typeof k.attr("data-latlong") ? k.attr("data-latlong") : !1, o = n ? 1 * n.substr(0, n.indexOf(",")) : !1, p = n ? 1 * n.substr(n.indexOf(",") + 1) : !1, q = new google.maps.Geocoder, r = "undefined" != typeof k.attr("data-address") ? k.attr("data-address").split(";") : [""], s = {}, t = {};
//             i = d.createEvent("Event"),
...
//                 optimised: !1
//             },
//             t.icon = "undefined" != typeof k.attr("data-marker-image") ? k.attr("data-marker-image") : void 0,
...
//             }, function(c, d) {
//                 d === google.maps.GeocoderStatus.OK && (b = new google.maps.Map(j,g),
//                 a.maps.instances.push(b),
//                 jQuery(j).trigger("mapCreated.maps.mr").get(0).dispatchEvent(i),
...
//                         }));
//                     else
//                         a.indexOf("[nomarker]") < 0 && (c = new google.maps.Geocoder,
//                         c.geocode({
...
//             c = new google.maps.Marker(jQuery.extend({}, h, {
//                 position: {
//                     lat: o,
//                     lng: p
//                 },
...
//             var c, d = b(this).find(".masonry__container"), e = b(this), f = "*", g = {};
//             c = {
...
//                 }
//             },
//             e.is("[data-default-filter]") && (f = e.attr("data-default-filter").toLowerCase(),
//             f = ".filter-" + f,
//             e.find("li[data-masonry-filter]").removeClass("active"),
//             e.find('li[data-masonry-filter="' + e.attr("data-default-filter").toLowerCase() + '"]').addClass("active")),
//             g.filter = "*" !== f ? f : void 0,
...
//             d.is(".masonry") && e.find(".masonry__item[data-masonry-filter]").length && (c = f.find("> ul"),
...
//             c.find('[data-masonry-filter="*"]').length || c.prepend('<li class="active" data-masonry-filter="*">' + g + "</li>"))
//         })
//     }
//     ,
...
//             a.is(".masonry") && (c.length && d.isotope("appended", c).isotope("layout"),
//             d.isotope("layout"))
//         })
//     }
//     ,
...
// //         "undefined" != typeof mr_parallax && (mr_parallax.profileParallaxElements(),
...
//             var b, c = jQuery(this), d = "#000000", e = 2e3, f = 110, g = 3, h = {}, i = {};
//             h = {
//                 animate: {
//                     duration: e,
//                     enabled: !0
...
// //         d = 0,
// //         b("body[data-smooth-scroll-offset]").length && (d = b("body").attr("data-smooth-scroll-offset"),
// //         d = 1 * d),
...
//             d.is("[id]") && (c = "#" + d.attr("id"),
//             history.pushState ? history.pushState(null, null, c) : location.hash = c)
//         }),
...
//         var c, e = b(a), f = e.closest(".tabs-container"), g = 1 * e.index() + 1, h = f.find("> .tabs-content > li:nth-of-type(" + g + ")"), i = d.createEvent("Event");
...
// //                     return c.hasClass("toggled-class") ? c.removeClass("toggled-class") : c.toggleClass("toggled-class"),
// //                     a(f).toggleClass(e),
// //                     !1
// //                 }))
// //             })
...
//             var a = b(this);
//             a.find("iframe[src]").length && (a.find("iframe").attr("data-src", a.find("iframe").attr("src")),
...
//                 autoFocus: !0
//             },
//             b.is('[role="application"][id^="steps-uid"]') || (b.steps(jQuery.extend({}, c, a.wizard.options)),
//             b.addClass("active"))
//         })
//     }
//     ,
